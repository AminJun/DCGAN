...
_G_PATH = 'https://github.com/AminJun/DCGAN/releases/download/DCGAN3/netG_epoch_99.pth'
_D_PATH = 'https://github.com/AminJun/DCGAN/releases/download/DCGAN3/netD_epoch_99.pth'
